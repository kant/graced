...
public class NTree implements Cloneable, Comparable<NTree> {
    ...
    public Object clone() {
        ...
        // XXX Aquí hay que clonar a los hijos también!!???.-
    ...
    public Vector<NTree> getSonsTotal() {
        ...
        // Agrego despuÃ©s los hijos de mis hijos recursivamente
...
//XXX: FALTA VER COMO HACEMOS CUANDO HAY FUNCIONES DE COSTO O HEURISTICAS.- 
